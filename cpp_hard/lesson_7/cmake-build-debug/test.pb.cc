...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mySpace::FullName, surname_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mySpace::Student, fname_),
  PROTOBUF_FIELD_OFFSET(::mySpace::Student, grades_),
  PROTOBUF_FIELD_OFFSET(::mySpace::Student, ascore_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::mySpace::FullName)},
  { 12, -1, -1, sizeof(::mySpace::Student)},
  { 21, -1, -1, sizeof(::mySpace::StudentsGroup)},
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\007mySpace\"Q\n\010FullName\022\014\n\004nam"
  "e\030\001 \001(\t\022\017\n\007surname\030\002 \001(\t\022\027\n\npatronymic\030\003"
  " \001(\tH\000\210\001\001B\r\n\013_patronymic\"K\n\007Student\022 \n\005f"
  "Name\030\001 \001(\0132\021.mySpace.FullName\022\016\n\006grades\030"
  "\002 \003(\r\022\016\n\006aScore\030\003 \001(\001\"3\n\rStudentsGroup\022\""
  "\n\010students\030\001 \003(\0132\020.mySpace.Studentb\006prot"
  "o3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_test_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, 242, descriptor_table_protodef_test_2eproto, "test.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "mySpace.FullName.surname"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
class Student::_Internal {
 public:
  static const ::mySpace::FullName& fname(const Student* msg);
};
...
Student::Student(const Student& from)
  ...
  if (from._internal_has_fname()) {
    fname_ = new ::mySpace::FullName(*from.fname_);
  } else {
    fname_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&ascore_) -
    reinterpret_cast<char*>(&fname_)) + sizeof(ascore_));
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 25)) {
          ascore_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Student::_InternalSerialize(
  ...
  double tmp_ascore = this->_internal_ascore();
  uint64_t raw_ascore;
  memcpy(&raw_ascore, &tmp_ascore, sizeof(tmp_ascore));
  if (raw_ascore != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(3, this->_internal_ascore(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:mySpace.Student)
  ...
  if (from._internal_has_fname()) {
    _internal_mutable_fname()->::mySpace::FullName::MergeFrom(from._internal_fname());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_ascore = from._internal_ascore();
  uint64_t raw_ascore;
  memcpy(&raw_ascore, &tmp_ascore, sizeof(tmp_ascore));
  if (raw_ascore != 0) {
    _internal_set_ascore(from._internal_ascore());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void Student::InternalSwap(Student* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Student, ascore_)
      + sizeof(Student::ascore_)
